...
export function setup(args) {
  ...
  // Set output filename to always write to the same file
  args.output = "/tmp/output.raw"; // Static file location for output
  console.log(`Output filename is "${args.output}"`);

  // ZeroMQ setup for communication
...
export function glitch_frame(frame, stream) {
  ...
  if (cur_mv) command.setup(cur_mv);
