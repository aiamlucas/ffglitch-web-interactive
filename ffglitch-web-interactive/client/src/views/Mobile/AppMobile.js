...
//   // Map gyroscope values to screen coordinates
//   const mapGyroscopeToScreenX = (gamma) => {
//     if (gamma === null || isNaN(gamma)) return ballPosition.x;
//     const screenWidth = window.innerWidth;
//     // Map gamma from -45 to 45 degrees to -screenWidth/2 to +screenWidth/2
//     const x = (gamma / 45) * (screenWidth / 2);
//     return Math.max(-screenWidth / 2, Math.min(screenWidth / 2, x));
//   };

//   const mapGyroscopeToScreenY = (beta) => {
//     if (beta === null || isNaN(beta)) return ballPosition.y;
//     const screenHeight = window.innerHeight;
//     // Map beta from -45 to 45 degrees to -screenHeight/2 to +screenHeight/2
//     const y = (beta / 45) * (screenHeight / 2);
//     return Math.max(-screenHeight / 2, Math.min(screenHeight / 2, y));
//   };
...
//         ? mapGyroscopeToScreenX(orientation?.gamma || 0)
//         : ballPosition.x;
//       const y = buttonValues[2]
//         ? mapGyroscopeToScreenY(orientation?.beta || 0)
//         : ballPosition.y;
...
//   // Other useEffect hooks for faders and buttons remain the same...
