...
// let previousToggleValues = {};
// // listen to events!:
// io.on("connection", (socket) => {
//   console.log(`User Connected: ${socket.id} `);

//   // Send the initial fader values to the client upon connection
//   socket.emit("initial_fader_values", faderValues);
...
//   // Send the initial toggle values to the client upon connection
//   socket.emit("initial_toggle_values", toggleValues);
